...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (([[NSUserDefaults standardUserDefaults] boolForKey:@"BypassDataEntry"] || [[NSUserDefaults standardUserDefaults] boolForKey:@"BypassSlideEntry"]) && [self isMovingToParentViewController]) {
